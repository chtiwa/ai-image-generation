...
const Home = () => {
  ...
  const handleSearchChange = (e) => {
    ...
    // inbound function so that it doesn't make an api call every time a new character is typed
    setSearchTimeout(
      setTimeout(() => {
  ...
  return (
    <section className='max-w-7x1 mx-auto'>
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w[500px]">Browse through imaginative and visually capturing images generated by ai.</p>
      </div>
